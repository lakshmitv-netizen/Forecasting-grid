...
const AddRemoveChildNodesModal: React.FC<AddRemoveChildNodesModalProps> = ({
  ...
  // Always include "Dimension" as first option, then add visible frozen columns
    ...
    if (isOpen) {
      ...
      if (!isInitializedRef.current) {
        ...
        if (currentFilter && currentFilter.filterColumn) {
          ...
          const initialColumn = filterColumns.length > 0 ? filterColumns[0].id : null;
        ...
        <div className="add-remove-child-nodes-popover-body">
          ...
          {filterColumns.length > 0 && (
            <div className="add-remove-child-nodes-filter-group">
              <label className="add-remove-child-nodes-filter-label">Filter By</label>
