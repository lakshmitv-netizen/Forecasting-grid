...
export const mockData: MeasureData[] = [
  // Sales Agreement Quantity
  {
    id: 'measure-sa-qty',
    name: 'Sales Agreement Quantity',
    values: monthlyValue(800),
    children: createHierarchy('measure-sa-qty', 800, 400, 80),
  },
  // Sales Agreement Revenue
  {
    ...
    children: createHierarchy('measure-sa-rev', 80000, 40000, 8000),
  },
  // Opportunity Quantity
  {
    ...
    children: createHierarchy('measure-opp-qty', 1200, 600, 120),
  },
  // Opportunity Revenue
  {
    id: 'measure-opp-rev',
    ...
    children: createHierarchy('measure-opp-rev', 120000, 60000, 12000),
  },
  // Order Quantity
  {
    ...
    children: createHierarchy('measure-order-qty', 950, 475, 95),
  },
  // Order Revenue
  {
    ...
    children: createHierarchy('measure-order-rev', 95000, 47500, 9500),
  },
  // Last Year Order Quantity
  {
    ...
    children: createHierarchy('measure-ly-order-qty', 750, 375, 75),
  },
  // Last Years Order Revenue
  {
    ...
    children: createHierarchy('measure-ly-order-rev', 75000, 37500, 7500),
  },
  // Forecasted Quantity
  {
    ...
    children: createHierarchy('measure-forecast-qty', 1000, 500, 100),
  },
  // Forecasted Revenue
  {
    ...
    children: createHierarchy('measure-forecast-rev', 100000, 50000, 10000),
  },
];
